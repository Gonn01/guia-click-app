...
extension IsarUserQueryFilter
  ...
  QueryBuilder<IsarUser, IsarUser, QAfterFilterCondition> userIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarUser, IsarUser, QAfterFilterCondition> userIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension IsarUserQueryObject
    on QueryBuilder<IsarUser, IsarUser, QFilterCondition> {
  QueryBuilder<IsarUser, IsarUser, QAfterFilterCondition> user(
      FilterQuery<User> q) {
    return QueryBuilder.apply(this, (query) {
...
extension IsarUserQueryProperty
  ...
  QueryBuilder<IsarUser, User?, QQueryOperations> userProperty() {
    return QueryBuilder.apply(this, (query) {
...
User _userDeserialize(
  ...
  final object = User(
    ...
    role: reader.readLongOrNull(offsets[3]),
